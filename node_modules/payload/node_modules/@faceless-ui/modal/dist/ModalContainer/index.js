...
var ModalContainer = function (props) {
    var _a = useModal_1.default(), oneIsOpen = _a.oneIsOpen, classPrefix = _a.classPrefix, transTime = _a.transTime, setContainerRef = _a.setContainerRef, containerRef = _a.containerRef, closeAll = _a.closeAll, closeOnBlur = _a.closeOnBlur;
    ...
    var Tag = htmlElement;
    return (react_1.default.createElement(react_transition_group_1.CSSTransition, { nodeRef: containerRef, in: oneIsOpen, timeout: transTime, classNames: generateTransitionClasses_1.default(baseClass), appear: true },
