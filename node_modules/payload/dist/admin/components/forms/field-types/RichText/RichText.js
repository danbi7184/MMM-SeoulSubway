            ...
            React.createElement(Slate, { editor: editor, value: valueToRender, onChange: (val) => {
                ...
                React.createElement("div", { className: `${baseClass}__wrapper` },
                    ...
                    React.createElement("div", { className: `${baseClass}__editor`, ref: editorRef },
                        React.createElement(Editable, { renderElement: renderElement, renderLeaf: renderLeaf, placeholder: placeholder, spellCheck: true, readOnly: readOnly, onBlur: onBlur, onKeyDown: (event) => {
                                if (event.key === 'Enter') {
                                    if (event.shiftKey) {
